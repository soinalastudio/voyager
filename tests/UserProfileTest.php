...
class UserProfileTest extends TestCase
{
    ...
    {
        $user = \SoinalaStudio\Voyager\Models\User::factory()->for(\SoinalaStudio\Voyager\Models\Role::factory())->create();
        ...
        $user->role->permissions()->attach(\SoinalaStudio\Voyager\Models\Permission::whereIn('key', [
            'browse_admin',
            'browse_users',
        ])->get()->pluck('id')->all());
