...
class VoyagerCategoriesController extends \SoinalaStudio\Voyager\Http\Controllers\VoyagerBaseController
{
    //...
}
```
...
class DataRow extends \SoinalaStudio\Voyager\Models\DataRow
{
    // ...
}
```
