...
use SoinalaStudio\Voyager\Events\FormFieldsRegistered;
use SoinalaStudio\Voyager\Facades\Voyager as VoyagerFacade;
use SoinalaStudio\Voyager\FormFields\After\DescriptionHandler;
use SoinalaStudio\Voyager\Http\Middleware\VoyagerAdminMiddleware;
use SoinalaStudio\Voyager\Models\MenuItem;
use SoinalaStudio\Voyager\Models\Setting;
use SoinalaStudio\Voyager\Policies\BasePolicy;
use SoinalaStudio\Voyager\Policies\MenuItemPolicy;
use SoinalaStudio\Voyager\Policies\SettingPolicy;
use SoinalaStudio\Voyager\Providers\VoyagerDummyServiceProvider;
use SoinalaStudio\Voyager\Providers\VoyagerEventServiceProvider;
use SoinalaStudio\Voyager\Seed;
use SoinalaStudio\Voyager\Translator\Collection as TranslatorCollection;
...
class VoyagerServiceProvider extends ServiceProvider
{
    ...
    protected function registerAlertComponents()
    {
        ...
        foreach ($components as $component) {
            $class = 'SoinalaStudio\\Voyager\\Alert\\Components\\'.ucfirst(Str::camel($component)).'Component';
    ...
    protected function registerFormFields()
    {
        ...
        foreach ($formFields as $formField) {
            ...
            VoyagerFacade::addFormField("SoinalaStudio\\Voyager\\FormFields\\{$class}");
        }
